...
const useListArticleReview = (token: string) => {
  ...
  const getArticles = async () => {
    ...
    const res = await articleServices.listArticleReview(token, query);
  ...
  const {
    ...
    queryKey: ["article_reviews", currentPage, currentLimit, currentSearch],
    queryFn: getArticles,
...
export default useListArticleReview;
