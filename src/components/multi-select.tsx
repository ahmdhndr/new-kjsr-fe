...
const multiSelectVariants = cva("m-1 transition-all duration-300 ease-in-out", {
  variants: {
    variant: {
      default: "border-foreground/10 text-primary bg-card hover:bg-card/80",
      secondary:
        ...
        >
          ...
          <PopoverTrigger asChild>
            <Button
              ...
              className={cn(
                "border-primary flex h-auto min-h-10 items-center justify-between rounded-md border bg-inherit p-1 hover:bg-inherit [&_svg]:pointer-events-auto",
                ...
                <div className="flex w-full items-center justify-between">
                  ...
                  >
                        ...
                        return (
                          ...
                          >
                            ...
                            <div
                              ...
                              className="-m-0.5 ml-2 h-4 w-4 cursor-pointer rounded-sm px-0.5 hover:bg-white/20 focus:ring-1 focus:ring-white/50 focus:outline-none"
                            >
                              <XCircle
                                className={cn(
                                  "h-3 w-3",
                    ...
                    {selectedValues.length > responsiveSettings.maxCount && (
                      <Badge
                        className={cn(
                          "text-primary border-foreground/1 bg-transparent hover:bg-transparent",
                          getBadgeAnimationClass(),
                          multiSelectVariants({ variant }),
                          responsiveSettings.compactMode &&
                            "px-1.5 py-0.5 text-xs",
                  ...
                  <div className="flex items-center justify-between">
                    <div
                      ...
                      className="text-muted-foreground hover:text-primary focus:ring-ring mx-2 flex h-4 w-4 cursor-pointer items-center justify-center rounded-sm focus:ring-2 focus:ring-offset-1 focus:outline-none"
                    >
          ...
          {animation > 0 && selectedValues.length > 0 && (
            <WandSparkles
              className={cn(
                "text-primary bg-background my-2 h-3 w-3 cursor-pointer",
